...
function BurndownCard({ currentSprint, currentProject }) {
  ...
  const fetchData = useCallback((signal) => {
    ...
    const url = `${API_BASE_URL}/jira/burndown/${companyName}?${params.toString()}`;
  ...
  const titleText = "Burndown";
  const infoText = "Daily sprint story points and hours burndown tracking progress";
  ...
  if (!hasData) {
    return (
      <DashboardCard
        ...
        className="q-card--chart"
      >
        <EmptyState title="No burndown data available" />
      </DashboardCard>
    );
  }
      ...
      <div className="flex flex-col h-full justify-between pt-1 pb-2 px-1">
          ...
          {hoverIndex !== null && hoverIndex >= 0 && hoverIndex < dates.length && (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted">Ideal:</span>
        ...
        <div className="flex items-center justify-center gap-6 mt-1 text-xs select-none">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted font-medium">Ideal</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-0.5 bg-cyan rounded-full" />
            <span className="text-muted font-medium">Actual</span>
          </div>
        </div>
      </div>
    </DashboardCard>
